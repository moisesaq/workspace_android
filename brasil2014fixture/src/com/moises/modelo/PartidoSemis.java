...
public class PartidoSemis {

	String idpartidosemis,idganador1,paisganador1,paisganador2,idganador2;
	Date fecha;
	Time hora;
	int gol1,gol2,estado, bandera1, bandera2;
	
	public PartidoSemis(String idpartidosemis,String idganador1,int bandera1, String paisganador1,int gol1, int gol2,int bandera2, String paisganador2, String idganador2, Date fecha, Time hora, int estado){
		this.idpartidosemis=idpartidosemis;
	...
	public String getIdpartidosemis() {
		return idpartidosemis;
	}

	public void setIdpartidosemis(String idpartidosemis) {
		this.idpartidosemis = idpartidosemis;
	}
