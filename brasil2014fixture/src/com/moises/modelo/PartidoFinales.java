...
public class PartidoFinales {

	String idpartidofinales,idganador1,paisganador1,paisganador2,idganador2;
	Date fecha;
	Time hora;
	int gol1,gol2,estado, bandera1, bandera2;
	
	public PartidoFinales(String idpartidofinales,String idganador1,int bandera1, String paisganador1,int gol1, int gol2,int bandera2, String paisganador2, String idganador2, Date fecha, Time hora, int estado){
		this.idpartidofinales=idpartidofinales;
	...
	public String getIdpartidofinales() {
		return idpartidofinales;
	}

	public void setIdpartidofinales(String idpartidofinales) {
		this.idpartidofinales = idpartidofinales;
	}
