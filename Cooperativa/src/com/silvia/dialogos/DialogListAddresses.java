...
import com.silvia.adapters.ListAddressAdapter;
...
public class DialogListAddresses extends DialogFragment implements OnItemClickListener{

	private View v;
	private ListView lvAddresses;
	private List<Address> list_address;
	public MapSucre mapSucre;
	
	public DialogListAddresses(List<Address> list_address, MapSucre mapSucre){
		this.list_address = list_address;
		this.mapSucre = mapSucre;
	}
	public Dialog onCreateDialog(Bundle savedInstanceState){
		AlertDialog.Builder dialog = new AlertDialog.Builder(getActivity());
		dialog.setTitle("Quiso decir");
		LayoutInflater inflater = (LayoutInflater)getActivity().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		v = inflater.inflate(R.layout.list_addresses, null);
		...
		ListAddressAdapter adapter = new ListAddressAdapter(getActivity(), list_address);
