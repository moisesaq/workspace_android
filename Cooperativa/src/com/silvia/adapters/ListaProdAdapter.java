...
public class ListaProdAdapter extends ArrayAdapter<Producto>{

	private Activity activity;
	private ImageLoader imageLoader;
	
	public ListaProdAdapter(Activity activity, List<Producto> lista_prod){
		super(activity, R.layout.modelo_item_prod, lista_prod);
	...
	public View getView(int position, View convertView, ViewGroup parent){
		...
		if(convertView==null){
			view = activity.getLayoutInflater().inflate(R.layout.modelo_item_prod, null);
			holder = new ViewHolder();
			holder.ivImageProd = (ImageView)view.findViewById(R.id.ivImageProdLProd);
			holder.tvNombreProd = (TextView)view.findViewById(R.id.tvNombreLProd);
			holder.tvPrecio = (TextView)view.findViewById(R.id.tvPrecioLProd);
			view.setTag(holder);
		}else{
